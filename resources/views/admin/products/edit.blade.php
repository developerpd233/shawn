...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="meta">{{ trans('cruds.product.fields.meta') }}</label>
                <input class="form-control {{ $errors->has('meta') ? 'is-invalid' : '' }}" type="text" name="meta" id="meta" value="{{ old('meta', $product->meta) }}">
                @if($errors->has('meta'))
                    <span class="text-danger">{{ $errors->first('meta') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.meta_helper') }}</span>
            </div>
            <div class="form-group">
